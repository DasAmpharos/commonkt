...
class LongValueFactory(
    ...
    private val minProperty: LongProperty = object : SimpleLongProperty(min) {
    ...
    private var min by minProperty

    private val maxProperty: LongProperty = object : SimpleLongProperty(max) {
        override fun invalidated() {
            val newMax = get()
    ...
    private var max by maxProperty
